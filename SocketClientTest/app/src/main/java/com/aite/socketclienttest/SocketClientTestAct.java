package com.aite.socketclienttest;
...
public class SocketClientTestAct extends AppCompatActivity implements View.OnClickListener {
    ...
    private class StartThread extends Thread {
        ...
        public void run() {
            ...
            try {
                socket = new Socket(etIP.getText().toString(), 40013);  //连接服务端的IP
                //启动接收数据的线程
